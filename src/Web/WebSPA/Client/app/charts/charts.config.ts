export const CHARTCONFIG = {
  ...
  star1:  'rgba(226, 32, 39,.85)', // #e22027
  star2:  'rgba(244, 115, 36,.85)', // #f47324
  star3:     'rgba(248, 204, 24,.85)', // #f8cc18
  star4:  'rgba(115, 177, 67,.85)', // #73b143
  star5:  'rgba(0, 127, 78,.85)', // #007f4e
};
