namespace Cloudmailin.Webhook
{
    ...
    using Cloudmailin.Webhook.Infrastructure.Filters;
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
            ...
            app.UseSwagger()
              .UseSwaggerUI(c =>
              {
                  ...
                  c.OAuthClientId("cloudmailinwebhookswaggerui");
                  c.OAuthAppName("Cloudmailin.Webhook Swagger UI");
              });
        }
